...
// 	}
//
// 	res, err := tapper.ResolveKegTargetForRepo(repoRoot, nil)
// 	if err != nil {
...
//
// 	res, err := tapper.ResolveKegTargetForRepo(tmp, nil)
// 	if err != nil {
// 		t.Fatalf("ResolveKegTargetForRepo returned error: %v", err)
// 	}
// 	if res.Value != envVal {
...
//
// 	res, err := tapper.ResolveKegTargetForRepo(root, nil)
// 	if err != nil {
// 		t.Fatalf("ResolveKegTargetForRepo returned error: %v", err)
// 	}
// 	if res.Source != "git" {
...
// 	defer os.Unsetenv("KEG_CURRENT")
//
// 	res, err := tapper.ResolveKegTargetForRepo(projRoot, nil)
// 	if err != nil {
// 		t.Fatalf("ResolveKegTargetForRepo returned error: %v", err)
// 	}
//
