...
//
// A repository-backed LocalKeg's read boundary is an exclusive lock, and every
// per-node read takes it. Batches of reads must therefore share one boundary rather than
