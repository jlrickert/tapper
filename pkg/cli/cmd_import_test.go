...
func TestImportCmd_BasicCopyWithLinkRewrite(t *testing.T) {
	...
	node1 := fixtureContent(t, sb.Runtime(), "work", "1")
	...
	node2 := fixtureContent(t, sb.Runtime(), "work", "2")
...
func TestImportCmd_AllNodesSkipsZero(t *testing.T) {
	...
	node0 := fixtureContent(t, sb.Runtime(), "work", "0")
...
func TestImportCmd_LeaveStubs(t *testing.T) {
	...
	stub := fixtureContent(t, sb.Runtime(), "personal", "1")
